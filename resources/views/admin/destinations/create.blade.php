                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Destination</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('destinations.store') }}" enctype="multipart/form-data" id="insert_data">
                        ...
                        <button type="submit" name="add_destinationtour" class="btn btn-primary" id="button_destination">Create</button>
                    </form>
                </div>
            </div>
        </div>
