...
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 align-self-center">
                <h4 class="page-title">Create Itinerary</h4>
    ...
    <div class="row">
        <div class="col-12 p-4">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('itineraries.store', $tour_id) }}" enctype="multipart/form-data" id="insert_data">
                        @csrf
                        ...
                        <button type="submit" name="add_itinerary" class="btn btn-primary" id="button_itinerary">Create</button>
                    </form>
                </div>
            </div>
        </div>
